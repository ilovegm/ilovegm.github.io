const GameDownUrlIos = "itms-services://?action=download-manifest&url=https://kh108gm.kkd666.com/whby/whby.plist"; // iOS
const GameDownUrlAndroid = "https://kh108gm.kkd666.com/whby/wuhuangbuyu.apk"; // Android

const TITLE = "武皇捕鱼"; // 当前名字
const DATE = "2024-06-17"; // 更新时间
const VERSION = "2.0.24.6(build 1)"; // 当前版本
